(function () {
    ...
    function getLocale() {
        if (window.NjcI18n && typeof window.NjcI18n.getLocaleForElement === "function" && pageCard) {
            return window.NjcI18n.getLocaleForElement(pageCard);
        }
