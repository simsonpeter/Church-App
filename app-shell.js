(function () {
    ...
    var tamilTranslations = {
        ...
        "dailyBread.archiveIntro": "மாதம் அல்லது தேதி தேர்ந்தெடுத்து பார்க்க.",
        "dailyBread.archiveMonthLabel": "மாதம்",
        "dailyBread.archiveShowMonth": "மாதத்தை காட்டு",
        "dailyBread.archiveToday": "இன்று",
        "dailyBread.spotlightLabel": "சிறப்பு எழுத்தாளர்",
        "dailyBread.guestPhotoAlt": "எழுத்தாளர் படம்",
        "dailyBread.readingLinkDefault": "இன்றைய வேத வாசிப்பு",
        "dailyBread.themeThisWeek": "இந்த வாரம்: {theme}",
        "dailyBread.themeThisWeekMany": "இந்த வாரம்: {themes}",
        ...
        "admin.dailyBreadThemePlaceholder": "திட்ட வகை (EN), எ.கா. நம்பிக்கை",
        "admin.dailyBreadThemeTaPlaceholder": "திட்ட வகை (தமிழ், விருப்பம்)",
        "admin.dailyBreadReadingHint": "வாசிப்பு திட்டம் (விருப்பம்): ஆங்கில வேதாகம புத்தகப் பெயர், அதிகாரம் மற்றும் வசனம். வேதாகம வாசகரை திறக்கும்.",
        "admin.dailyBreadReadingBookPlaceholder": "புத்தகம் (EN), எ.கா. John",
        "admin.dailyBreadReadingChapterPlaceholder": "அதிகாரம்",
        "admin.dailyBreadReadingVersePlaceholder": "வசனம் (விருப்பம்)",
        "admin.dailyBreadReadingLabelPlaceholder": "இணைப்பு உரை (EN)",
        "admin.dailyBreadReadingLabelTaPlaceholder": "இணைப்பு உரை (தமிழ், விருப்பம்)",
        "admin.dailyBreadPhotoPlaceholder": "எழுத்தாளர் பட URL (https://…)",
        "admin.dailyBreadBioPlaceholder": "எழுத்தாளர் சுருக்கம் (EN, விருப்பம்)",
        "admin.dailyBreadBioTaPlaceholder": "எழுத்தாளர் சுருக்கம் (தமிழ், விருப்பம்)",
        "admin.dailyBreadSpotlight": "வாராந்திர சிறப்பு எழுத்தாளர் பட்டியலில் சேர் (இந்த வாரம் குறித்தவர்கள் மட்டும் சுழலும்)",
        "admin.dailyBreadLoadIntoForm": "படிவத்தில் ஏற்ற தேதி",
        "admin.dailyBreadLoadBtn": "ஏற்று",
        "admin.dailyBreadNeedReadingChapter": "வாசிப்பு இணைப்புக்கு அதிகார எண்ணை உள்ளிடவும்.",
        "admin.dailyBreadListSpotlight": "சிறப்பு",
        "admin.dailyBreadEditPromptTheme": "திட்ட வகை (EN, விருப்பம்)",
        "admin.dailyBreadEditPromptThemeTa": "திட்ட வகை (தமிழ், விருப்பம்)",
        "admin.dailyBreadEditPromptReadingBook": "வாசிப்பு: வேத புத்தகம் (EN, எ.கா. John), விருப்பம்",
        "admin.dailyBreadEditPromptReadingChapter": "வாசிப்பு: அதிகாரம் (1 முதல்), அல்லது காலி",
        "admin.dailyBreadEditPromptReadingVerse": "வாசிப்பு: வசனம் (விருப்பம்), அல்லது காலி",
        "admin.dailyBreadEditPromptReadingLabel": "வாசிப்பு இணைப்பு உரை (EN, விருப்பம்)",
        "admin.dailyBreadEditPromptReadingLabelTa": "வாசிப்பு இணைப்பு உரை (தமிழ், விருப்பம்)",
        "admin.dailyBreadEditPromptPhoto": "எழுத்தாளர் பட URL (https, விருப்பம்)",
        "admin.dailyBreadEditPromptBio": "எழுத்தாளர் சுருக்கம் (EN, விருப்பம்)",
        "admin.dailyBreadEditPromptBioTa": "எழுத்தாளர் சுருக்கம் (தமிழ், விருப்பம்)",
        "admin.dailyBreadEditPromptSpotlight": "வாராந்திர சிறப்பு எழுத்தாளராக காட்டவா?",
        "admin.dailyBreadLoadNeedDate": "ஏற்ற தேதியை தேர்ந்தெடுக்கவும்.",
        "admin.dailyBreadLoadNotFound": "அந்த தேதிக்கு பதிவு இல்லை.",
        "admin.dailyBreadLoadedIntoForm": "படிவத்தில் ஏற்றப்பட்டது. புதுப்பிக்க சேமிக்கவும்.",
