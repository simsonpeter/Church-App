(function () {
    ...
    var tamilTranslations = {
        ...
        "admin.noticeImageSizeHint": "படம் மட்டும்: ஏற்றுமதி 1200×675 px (16∶9) அல்லது 1200×800 px (3∶2). பயன்பாடு முழு படத்தை ~360px உயர பேனரில் காட்டும் (வெட்டாது). வேறு வடிவங்களில் மென்மையான பட்டைகள்.",
