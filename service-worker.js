const APP_CACHE = "njc-app-cache-v140";
const RUNTIME_CACHE = "njc-runtime-cache-v140";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260325u3",
    "./user-auth.js?v=20260324u3",
    "./app-shell.js?v=20260325u4",
