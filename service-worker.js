const APP_CACHE = "njc-app-cache-v221";
const RUNTIME_CACHE = "njc-runtime-cache-v221";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260330db5",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260330db5",
    ...
    "./daily-bread-page.js?v=20260330db3",
