...
const APP_CACHE = "njc-app-cache-v294celeui";
const RUNTIME_CACHE = "njc-runtime-cache-v294celeui";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260411celeui1",
    ...
    "./celebration-wish-thread.js?v=20260411celeui1",
