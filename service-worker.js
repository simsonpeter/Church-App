...
const APP_CACHE = "njc-app-cache-v297upcomingyr";
const RUNTIME_CACHE = "njc-runtime-cache-v297upcomingyr";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260412upcomingyr1",
    ...
    "./celebrations-page.js?v=20260412upcomingyr1",
