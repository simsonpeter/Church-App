const APP_CACHE = "njc-app-cache-v249";
const RUNTIME_CACHE = "njc-runtime-cache-v249";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260331bs1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260331contact2",
