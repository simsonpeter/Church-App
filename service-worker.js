const APP_CACHE = "njc-app-cache-v195";
const RUNTIME_CACHE = "njc-runtime-cache-v195";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260408main1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260408u2",
    ...
    "./announcements-banner.svg?v=20260409ab1",
    "./announcements.json"
];
