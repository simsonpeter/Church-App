const APP_CACHE = "njc-app-cache-v267";
const RUNTIME_CACHE = "njc-runtime-cache-v267";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260404imgfixed1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260402admincollapse1",
    "./events-engine.js?v=20260318de",
    "./home-page.js?v=20260404imgfixed1",
