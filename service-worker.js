const APP_CACHE = "njc-app-cache-v192";
const RUNTIME_CACHE = "njc-runtime-cache-v192";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260407read1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260407u1",
    ...
    "./reading-plan-banner.svg?v=20260407",
    "./announcements.json"
];
