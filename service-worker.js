const APP_CACHE = "njc-app-cache-v139";
const RUNTIME_CACHE = "njc-runtime-cache-v139";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260325u2",
    "./user-auth.js?v=20260324u3",
    "./app-shell.js?v=20260325u3",
