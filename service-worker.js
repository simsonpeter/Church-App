const APP_CACHE = "njc-app-cache-v2";
const RUNTIME_CACHE = "njc-runtime-cache-v2";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260310q",
    "./events-engine.js?v=20260310q",
    "./site.webmanifest?v=20260310q",
    "./logo.png?v=20260310q"
];
