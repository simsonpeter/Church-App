...
const APP_CACHE = "njc-app-cache-v305sermonlistens";
const RUNTIME_CACHE = "njc-runtime-cache-v305sermonlistens";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260506listen1",
    "./user-auth.js?v=20260412commceleb1",
    "./app-shell.js?v=20260506listen1",
    "./events-engine.js?v=20260318de",
    "./home-page.js?v=20260412annpartner1",
    "./events-page.js?v=20260414u2",
    "./sermons-page.js?v=20260506listen1",
