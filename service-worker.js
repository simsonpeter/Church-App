const APP_CACHE = "njc-app-cache-v119";
const RUNTIME_CACHE = "njc-runtime-cache-v119";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260318de",
    "./events-engine.js?v=20260318de",
    "./home-page.js?v=20260320tr2",
