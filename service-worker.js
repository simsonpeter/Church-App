const APP_CACHE = "njc-app-cache-v150";
const RUNTIME_CACHE = "njc-runtime-cache-v150";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260328u2",
    "./user-auth.js?v=20260328u2",
