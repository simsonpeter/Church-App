const APP_CACHE = "njc-app-cache-v201";
const RUNTIME_CACHE = "njc-runtime-cache-v201";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260412pw1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260412u1",
    ...
    "./prayer-banner.jpg?v=20260412pw1",
