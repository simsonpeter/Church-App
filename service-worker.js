const APP_CACHE = "njc-app-cache-v251";
const RUNTIME_CACHE = "njc-runtime-cache-v251";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260331libtabs1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260331libtabs1",
    ...
    "./admin-dashboard-page.js?v=20260331libtabs1",
    ...
    "./spa-router.js?v=20260331libtabs1",
    "./book-shelf-page.js?v=20260331libtabs1",
    "./books.json?v=20260331libtabs1",
