const APP_CACHE = "njc-app-cache-v209";
const RUNTIME_CACHE = "njc-runtime-cache-v209";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260328pw1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260328pw1",
    ...
    "./prayer-banner.jpg?v=20260328pw1",
