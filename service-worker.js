const APP_CACHE = "njc-app-cache-v124";
const RUNTIME_CACHE = "njc-runtime-cache-v124";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260322t1",
    "./user-auth.js?v=20260318de",
    "./app-shell.js?v=20260322t2",
