...
const APP_CACHE = "njc-app-cache-v329myprayertext";
const RUNTIME_CACHE = "njc-runtime-cache-v329myprayertext";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260414myprayertext1",
    ...
    "./contact-page.js?v=20260414myprayertext1",
