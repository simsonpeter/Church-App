const APP_CACHE = "njc-app-cache-v151";
const RUNTIME_CACHE = "njc-runtime-cache-v151";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260329u1",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260329u1",
