const APP_CACHE = "njc-app-cache-v125";
const RUNTIME_CACHE = "njc-runtime-cache-v125";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260322t3",
    "./user-auth.js?v=20260318de",
    "./app-shell.js?v=20260322t3",
