const APP_CACHE = "njc-app-cache-v222";
const RUNTIME_CACHE = "njc-runtime-cache-v222";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260330db6",
    "./user-auth.js?v=20260329u1",
    "./app-shell.js?v=20260330db6",
