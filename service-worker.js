const APP_CACHE = "njc-app-cache-v1";
const RUNTIME_CACHE = "njc-runtime-cache-v1";
...
const CORE_ASSETS = [
    ...
    "./app-shell.js?v=20260310p",
    "./events-engine.js?v=20260310p",
    "./site.webmanifest?v=20260310p",
    "./logo.png?v=20260310p"
];
