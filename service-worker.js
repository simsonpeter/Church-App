...
const APP_CACHE = "njc-app-cache-v293celehome";
const RUNTIME_CACHE = "njc-runtime-cache-v293celehome";

const CORE_ASSETS = [
    "./",
    "./index.html",
    "./styles.css?v=20260411celehome1",
    "./user-auth.js?v=20260407fcm1",
    "./app-shell.js?v=20260411celehome1",
